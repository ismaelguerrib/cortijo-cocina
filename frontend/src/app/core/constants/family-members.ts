export const FAMILY_MEMBERS = [
  ...
  { value: 'AMEL', label: 'Amel', picture: 'amel.jpeg' },
  { value: 'ZAKARIA', label: 'Zakaria', picture: 'zakaria.jpeg' },
  ...
  { value: 'NOUR', label: 'Nour', picture: 'nour.jpeg' },
  { value: 'LINA', label: 'Lina', picture: 'lina.jpeg' },
  { value: 'HIMA', label: 'Hima', picture: 'hima.jpeg' },
  { value: 'ANOUK', label: 'Anouk', picture: 'anouk.jpeg' },
